(() => {
  const refs = {
    mobileMenuBtn: document.querySelector('[data-mobilemenu-btn]'),
    mobileMenu: document.querySelector('[data-mobilemenu-list]'),
  };

  refs.mobileMenuBtn.addEventListener('click', toggleMobileMenu);
 ...
  function toggleMobileMenu() {
  ...
  window.matchMedia('(min-width: 768px)').addEventListener('change', e => {
    ...
    refs.mobileMenuBtn.setAttribute('aria-expanded', false);
